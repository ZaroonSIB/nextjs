      ...
      <header className="py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between align-items-center">
            <div className="flex align-items-center md:gap-x-12">
              ...
              <div className="flex gap-x-6">
                <Link
                  href="/"
                  className="py-2 px-3 hover:bg-slate-100 hover:text-blue-600 rounded-lg font-semibold"
                >
                  Features
                </Link>
                <Link
            ...
            <Link
              href="/"
              className="bg-blue-600 px-6 py-4 text-white font-semibold rounded-lg text-sm uppercase hover:bg-blue-100 hover:text-blue-600"
            >
              Get Started Today
            </Link>
          </div>
